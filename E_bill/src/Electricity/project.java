...
public class project extends JFrame implements ActionListener{
    ...
    project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon/home.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icon/new.jpg"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("icon/cust.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icon/acc.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon/gen.png"));
        ...
        ImageIcon icon41 = new ImageIcon(ClassLoader.getSystemResource("icon/up.png"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icon/his.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icon/gen.png"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("icon/note.png"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("icon/calc.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/brw.png"));
