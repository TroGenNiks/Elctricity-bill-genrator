...
public class Signup extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            String person = c1.getSelectedItem();
            ...
            try{
                ...
                if(person.equals("Admin")){
                    str = "insert into login values('"+meter+"', '"+username+"', '"+name+"', '"+password+"', '"+person+"')";
//                    create table login(meter_no varchar(20), username varchar(30), name varchar(30), password varchar(30), user varchar(30));
                }else{
                    str1 = "insert into login values('"+meter+"', '"+username+"', '"+name+"', '"+password+"', '"+person+"')";
                   str = "update login set username = '"+username+"', name = '"+name+"', password = '"+password+"', user = '"+person+"' where meter_no = '"+t4.getText()+"'";
